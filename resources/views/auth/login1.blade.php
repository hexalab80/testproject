  ...
  <form class="" action="{{route('login')}}" method="post">
    ...
    <div class="row section">
      ...
      <div class="col s12 m6">
        <div class="card">
          <div class="card-title red lighten-2 white-text  padding-15">
            <center><span class="small">SIGN IN TO MizohPay <br><small>Please sign in to MizohPay</small></span></center>
          </div>
