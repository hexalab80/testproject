...
class UserController extends Controller
{
  ...
  {   
   ...
   // $reward_ads_info->ads_timestamp1 = microtime($reward_ads_info->created_at);
    ...
    $setting->condition = '<ol><li> The amount should be a maximum of 80 percent of the wallet balance.</li><li> It may take up to 24-72 working hours for the amount to get credited in your above mentioned PayTm account.</li><ol>';
    return $setting;
